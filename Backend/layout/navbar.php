...
<head>
  ...
  <link rel="icon" href="Images/tanah longsor.jpg">
  <title>Landslides Warning Center</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow">
    <div class="container">
      <a class="navbar-brand" href="admin.php">
        <img class="rounded-circle" src="Images/tanah longsor.jpg" alt="Logo Tsunami">
        <b>Landslides Warning Center</b>
      </a>
