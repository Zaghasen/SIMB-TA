                ...
                <div class="card-body">
                    ...
                    <form action="funct.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama" value="<?= @$hilang['nama']; ?>" class="form-control"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea rows="4" type="text" name="alamat" value="<?= @$hilang['alamat']; ?>"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="telp" value="<?= @$hilang['telp']; ?>" class="form-control"
                                    required>
                            </div>
                        </div>
                        <div class="row mb-3 ">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                atau
                                <a href="temukan.php" style="color:grey;">Batal</a>
                            </div>
                    </form>
                </div>
            </div>
